          ...
          if( !empty($userCmp['business_id']) && $userCmp['business_id']==$at->business_id){
            if($user_status['user_status']=="1"){
              ...
              if(empty($checkOffline)){
                ...
                //   $this->sendNotification($company['firebassid'],$notificationTitle,$notificationMessage);
                }
...
function addRfid(){
        ...
        foreach($allBusiness as $bus){
          ...
          if(!empty($usersData)){
            ...
            if(!empty($bus->firebassid)){
              $this->sendNotification($bus->firebassid,$notificationTitle,$notificationMessage);
            }
          }
        }
        $this->db->where('id',1);
  ...
  function sendNotification($target,$title,$message){
    //API URL of FCM
    $url = 'https://fcm.googleapis.com/fcm/send';
