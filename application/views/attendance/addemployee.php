            ...
            <div class="col-md-12">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Add Employee</h3><br>
                  ...
                  if (!empty($umobile)){
                    ...
                    <form action="<?php echo base_url('User/addstaff')?>" method="post">
                      <div class="card-body">
                        ...
                        ?>
                        <h5> Please Register New Employee </h5>
                        <form action="<?php echo base_url('User/addnewemployee')?>" method="post">
                          <div class="card-body">
                            <div class="row">
                              <div class="from-group col-md-5">
                                <label for="mobile">Enroll ID/Mobile No</label>
                              ...
                              <div class="from-group col-md-5">
                                ...
                                <input type="text" class="form-control" name="desig" id="desig" placeholder="Enter desig"  >
                              </div>
                              <div class="from-group col-md-5">
                                ...
                                <select name="group" class="form-control"  id="group" >
                                  ...
                                  <option value="" disabled selected>Select</option>-->
                                  <?php
                                   $group = $this->web->getBusinessGroupByBusinessId($buid);
                                  if(!empty($group)){
                                ...
                                <div class="from-group col-md-5">
                                  ...
                                  <div class="from-group col-md-5">
                                    <br>
                                    <button  class=" btn btn-success mt-4 mx-auto" >Add to company</button>
                                    <a href="<?php echo base_url('employees')?>"<button class=" btn btn-success mt-4 mx-auto" >Cancel</button> </a>
                                  </div>
                                </div>
                              </div>
