...
<body class="hold-transition sidebar-mini">
  ...
  ?>
      ...
      ?>
        ...
        <?php
        if($this->session->userdata()['type']=='B' || $role[0]->manual_att=="1" || $role[0]->type=="1"){?>
          <div class="container-fluid">
            <div class="row">
              <!-- left column -->
              <div class="col-md-12">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-lg-12 float-left">
                        <form action="<?php echo base_url('User/manual_attendance') ?>" method="POST">
                          <div class="row">
                            <div class="col-sm-2">
                  ...
                  foreach ($res as $key => $dataVal) {
                    ...
                    if(!is_bool($roleTeam) || !is_bool($roleSection) || !is_bool($roleDp)){
                      ...
                      unset($res[$key]);
                            ...
                            <div class="col-sm-2">
                              <input type="date" name="end_date" id="end_date" value="<?php echo $end_date; ?>" class="form-control" max="<?php echo date('Y-m-d'); ?>"  onchange="endChange(event);">
                            </div>
                            <div class="col-sm-2">
                              <button type="submit" class="btn btn-success btn-fill btn-block">Show</button>
                            </div>
                            <div class="col-sm-2">
                              <a href="<?php echo base_url('manual_report') ?>"><button type="button" class="btn btn-primary btn-fill btn-block">Manual Report</button></a>
                            </div>
                          </div>
                        </form>
                      </div>
