              ...
              <div class="col-md-12">
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title"> Assigned Working</h3>
                  </div>
                  <div class="card-body">
                    <h5> Select Date</h5>
                    <div class="row">
                      <div class="col-lg-12 float-left">
                        <form action="<?php echo base_url('User/request_wfh') ?>" method="POST">
                          <div class="row">
                           <div class="col-sm-2">
                            ...
                            <div class="col-sm-2">
                             <!-- <input type="date" name="date" id="date" value="" class="form-control">-->
                              <input type="hidden" name="bid"  value="<?php echo $loginId;?>" class="form-control">
                              <input type="hidden" name="uid"  value="<?php echo $empId ;?>" class="form-control">
                    ...
                    ?>
                      ...
                      <table id="example2" class="table table-bordered table-striped">
                        ...
                        <tbody>
                         <?php
					  $res = $this->web->getempassignworking($empId);
