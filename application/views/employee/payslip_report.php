...
<body>
    ...
    <div class="container">
       ...
       //  echo $buid;
        ...
        ?>
                  <p class="sub-heading">PAY SLIP FOR THE MONTH OF:  <?=date("M Y", strtotime($date) ); ?> </p>
      </div>
            ...
            <table class="" border="2">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="w-20"><?=cal_days_in_month(CAL_GREGORIAN,date('m',strtotime($date)),date('Y',strtotime($date))); ?></td>
            ...
            <table class="" border="2">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>NetPayable : <?= $net_paid_day-$advance_paid; ?></td>
                    </tr>
            ...
            <table class="" border="2">
                <thead>
                    ...
                    <tr>
                        ...
                        <td><?=$entitleleave;?></td>
                        <td><?=$usedleave;?></td>
                        <td><?=$openleave+$entitleleave-$usedleave?></td>
                    </tr>
                </thead>
            </table>
            <br />
