          ...
          <div class="col-md-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Request  Attendance</h3><br>
			  ...
			  $loginId = $userCmp['business_id'];	
			   ...
			   ?>
             <form action="<?php echo base_url('User/req_att')?>" method="post">
              <div class="card-body">
                <div class="row">
                  ...
                  <!--  <input type="date" class="form-control" name="from_date" placeholder="Select Date" id="from_date" required>-->
                     <input type="date"  name="date" placeholder="Date" id="date" value="<?php echo $date ; ?>" class="form-control"  required>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Pending Attendance</h3>
               
              </div>
              <div class="card-body">
               <?php   $att = $this->web->getpendingatt($loginId,$empId); 
                                   ...
                                   <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                      ...
                                      foreach($att as $att){
                                        ...
                                        <tr>
                                          <td><?= $count++;?></td>
                                          <td><?= date('d-m-Y',$att->io_time);?></td>
                                          <td><?= $att->mode?></td>
                                          <td><?= date('h:i:A',$att->io_time);?></td>
                                          <td><?= $att->comment;?></td>
                                          <td> <?php if($att->verified=="1"){
                                             echo "Verified"; 
                                              
                                          }elseif($att->verified=="2")
                                          {
                                           echo "Cancelled";    
                                          } else {
                                           echo "Pending";     
