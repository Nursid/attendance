...
<h5 class="login-box-msg">MCS Employee Login</h5>
      <form action="<?php echo base_url('User/staff_log')?>" method="post">
...
<div> <h5><a href="<?php echo base_url('user-login')?>" class="nav-link"> Click Here for Business Login </a> </h5> </div>
