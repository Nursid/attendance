        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Salary Head student </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Salary Head student </h3><br>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Student Headers</h3>
              </div>
              <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    $query = $this->db->query("SELECT * FROM ctc_head WHERE bid = ".$this->session->userdata('login_id')." AND name <> 'TA' AND name <> 'DA' AND name <> 'HRA' AND name <> 'MEAL' AND name <> 'CONVEYANCE' AND name <> 'MEDICAL' AND name <> 'SPECIAL' AND name <> 'PF' AND name <> 'ESI' AND name <> 'TDS'")->result();
