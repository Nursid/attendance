...
<div class="wrapper">
 <?php $this->load->view('menu/menu')?>
  ...
  <div class="content-wrapper">
    ...
    <?php
	$login_id=$this->session->userdata();
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Departments Assigned</h3><br>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $sub_name['depart_name'];?></td>
						 <td>
                        <a href="<?php echo base_url()?>User/updateappointPage/<?php echo $login_id['id']?>/<?php echo $login_id['login_id'];?>/<?php echo $res['0']->id;?>/<?php echo $sub_name['id'];?>"class="btn btn-md btn-primary" title="view"><i class="fas fa-edit"></i></a></td>
                      </tr>
                      <?php 
                        }
                      }else{
                      ...
                      <tr>
                        ...
                        <td><?php echo $res['0']->department; ?></td>
                        <td>----</td>
						 <td><a href="<?php echo base_url()?>User/updateappointPage/<?php echo $login_id['id']?>/<?php echo $login_id['login_id'];?>/<?php echo $res['0']->id;?>"class="btn btn-md btn-primary" title="view"><i class="fas fa-edit"></i></a></td>
                      </tr>
