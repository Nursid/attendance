          ...
          <div class="col-md-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Class</h3><br>
                <span style="color: red"><?php echo $this->session->flashdata('msg');?></span>
              </div>
              <form action="<?php echo base_url('User/add_newclass')?>" method="post">
              <div class="card-body">
                <div class="row">
                  <div class="from-group col-md-5">
                    <label for="depart">Name</label>
                    <input type="text" class="form-control" name="class" placeholder="Enter a name" id="depart" required>
                  </div>
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                      $res = $this->web->getallclassbyid($buid);
                      $count=1;
                      foreach($res as $res){
                      ?>
                      <tr>
