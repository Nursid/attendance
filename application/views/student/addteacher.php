            ...
            <div class="col-md-12">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Add Teacher</h3><br>
				...
				//  $max_mobile =1;
				//  if(!empty($maxid[0]->mobile) && is_numeric($maxid[0]->mobile)){
				 //     $max_mobile=($maxid[0]->mobile) + 1;
				 // }
				//  $max_bio_id = 1;
				//  if(!empty($maxdevid[0]->bio_id) && is_numeric($maxdevid[0]->bio_id)){
				   //   $max_bio_id=($maxdevid[0]->bio_id)+1;
				 // }
				   
				  // $max_emp_code=1;
				   //if(!empty($maxempcode[0]->emp_code) && is_numeric($maxempcode[0]->emp_code)){
                  ...
                  if ($mob==0){
                    ...
                    ?>
                    <h5> Enter Enroll Id/Mobile No. </h5>
                    <div class="row">
                      ...
                      <div class="col-lg-7 ">
                         <form action="" method="GET">
                           <div class="row">
                             ...
                             <div class="col-3">
                    <input type="hidden" class="form-control"  name="mob" id="mob" value="<?php echo $max_mobile ;?>">
                  <input type="hidden" class="form-control"  name="bio_id" id="bio_id" value="<?php echo $max_bio_id ;?>">
               <input type="hidden" class="form-control"  name="emp_code" id="emp_code" value="<?php echo $max_emp_code ;?>">
                              <button type="submit" class="btn btn-success btn-fill btn-block">Register</button>
                            </div>
                          </div>
                        </form>
                ...
                <!--    <div class="row" >
                      <div class="col-lg-7 float-left">   
                <h6> Import staff from Excel. </h6>    
             <form method="post" enctype="multipart/form-data" action="<?php echo base_url('User/import_staff')?>">
<input type="file" id="excel_file" name="excel_file">
<input type="hidden" id="business_id" name="business_id">
  <input type="submit" value="Upload">
</form>
<a download href="<?php echo base_url() ?>/upload/template/staff.xlsx">Download Staff Sample file</a>
</div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="from-group col-md-5">
                            ...
                            <a href="<?php echo base_url('add_teachers')?>"    <button class=" btn btn-success mt-4 mx-auto" >Cancel</button> </a>
                          </div>
                        </div></div></form>
                        <?php
                      }else {
                        ...
                        ?>
                        <h5> Please Register New Teacher </h5>
                        <form action="<?php echo base_url('User/addnewteachers')?>" method="post">
                          <div class="card-body">
                            <div class="row">
                              <div class="from-group col-md-5">
                                <label for="mobile">Enroll ID/Mobile No</label>
                                <input type="text" class="form-control" value="<?php echo $mob; ?>"  name="mobile" id="mobile">
                              </div>
                              <div class="from-group col-md-5">
                                <label for="name">Name</label>
                              ...
                              <div class="from-group col-md-5">
                                ...
                                <input type="email" class="form-control" name="email" placeholder="Enter Email_id" id="email" >
                              </div>
                              <div class="from-group col-md-5">
                              ...
                              <div class="from-group col-md-5">
                                ...
                                <input type="text" class="form-control" name="empcode" id="empcode" value="<?php echo $emp_code; ?>">
                              </div>
                              ...
                              <div class="from-group col-md-5">
                               ...
                               <div class="from-group col-md-5">
                 <label for="block">Subject</label>
                            <select name="subject" class="form-control"  id="block" >
                              <option value="">Select Subject</option>    
                                 
                   <?php
				  
				   $classesub = $this->web->getallsubjectbyid($buid);
                    if(!empty($classesub)){
                      foreach($classesub as $clas):
                   ...
                   ?></select>
                    ...
                    <!--
                  <div class="from-group col-md-5">
                                <label for="empcode">Class Room</label>
                                <input type="text" class="form-control" name="class_room" id="devcode" value="<?php echo $bio_id; ?>" >
                              </div>
                              ...
                              <!--   <div class="from-group col-md-5">
                                   ...
                                   <div class="from-group col-md-5">
                                <label for="empcode">Section</label>
                                <input type="text" class="form-control" name="section"  >
                              </div>
                              
                              
                               <div class="from-group col-md-5">
                                 <label for="empcode">Batch</label>
                                 <input type="text" class="form-control" name="batch"  >
                               </div>
                                     <div class="from-group col-md-5">
                                 <label for="empcode">Semester</label>
                                 <input type="text" class="form-control" name="semester"  >
                               </div>
                                   
                                     
                                   <div class="from-group col-md-5">
                                 <label for="empcode">Session</label>
