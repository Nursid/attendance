                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-lg-12 float-left">
                        <form action="<?php echo base_url('User/students_report')?>" method="POST">
                          <div class="row">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-2 ">
                              ...
                              <select name="emp" class="form-control" name="emp"  id="emp" >
                                ...
                                //   }
                                // }
                                $res=$this->web->getSchoolStudentList($loginId);
                                ...
                                foreach($res as $res):
                                  ...
                                  ?>
                                  <option value="<?php echo $res->id  ?>" <?php echo $select; ?>><?php echo $res->name; ?></option>
                                  <?php
                                endforeach;
                                ?></select>
