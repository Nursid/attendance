              ...
              <table id="example1" class="table table-bordered table-responsive">
                  ...
                  <tbody>
                      ...
                      foreach($premium as $pre){
						 ...
						 $activeb = $this->web->getuserByidStatus($buid);
						   ...
						   // $att_all="SELECT count(id) as attend_all FROM attendance WHERE bussiness_id='$activeb->id' ";
				...
				//		       
                    ...
                    <td>
                          ...
                          <?php 
						  $check = $this->web->checkGeneratedLogin($activeb->id);
                               if(empty($check)){
                    ...
                    <td>
                     <?php $licence = $this->web->getactivelicence($activeb->id);
					//echo $id;
				   $assign_id=$licence[0]->assign_id;
					 $assigned_by = $this->web->getNameByAssignId($assign_id);
					  echo "<br>Licence by:-".$assigned_by[0]->name;                     
				   ...
				   ?>
                    ...
                    <td>
                    <?php $act="SELECT count(id) as actemp FROM user_request WHERE business_id='$activeb->id' and left_date ='' ";
                    ...
                    <td id="delete<?php echo $activeb->id; ?>">
                       <?php
					   $status=$activeb->deleted;
					   if ($status==0) {
						   echo Active; ?>
						    <button class="btn"  onclick="deleted_user('<?php echo $activeb->id; ?>')" >
