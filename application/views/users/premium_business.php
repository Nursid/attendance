              ...
              <table id="example3" class="table table-bordered table-responsive">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php 
                        echo date("d-M-Y", $pre->start_date);
                        
                        ?>
                      <br> <br>
                      <?php 
                        echo date("d-M-Y", $pre->validity);
                      ...
                      <?php 
						 ...
						 $refer=$pre->reference;
						 $unames = $this->web->getIdByMb($refer);
					   // $linked_id=$unames[0]->id;
					  echo "-". $unames[0]->name;
					  
					  
					  ?>
                      <button type="button"  data-toggle="modal" data-target="#myModal2" onclick="mclick2('<?php echo $pre->id; ?>')">
					...
					//echo $id;
					 ...
					 $assigned_by = $this->web->getNameByAssignId($assign_id);
					  ...
					  ?>
                      <button type="button"  data-toggle="modal" data-target="#myModal3" onclick="mclick3('<?php echo $pre->id; ?>')">
                             <i class="fa fa-edit" style="color:red"></i>
                          </button>
