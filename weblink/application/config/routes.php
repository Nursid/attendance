...
$route['device_access_admin'] = 'User/device_access_admin';
$route['bio_detail'] = 'User/bio_detail';
/////////////
$route['employees'] = 'User/employees';
$route['addemployee'] = 'User/addemployee';
$route['dailyreport'] = 'User/daily_report';
...
$route['device_access_att'] = 'User/device_access_att';
/////
...
$route['add_student'] = 'User/add_student';
$route['student_list'] = 'User/student_list';
$route['exstudent_list'] = 'User/exstudent_list';
...
$route['hostel_student_report'] = 'User/hostel_student_report';
$route['complain_detail'] = 'User/complain_detail';
$route['canteen_rule'] = 'User/canteen_rule';
$route['canteen_device'] = 'User/canteen_device';
$route['timing'] = 'User/timing';
$route['add_membership'] = 'User/add_membership';
$route['membership_detail'] = 'User/membership';
$route['canteen_daily_report'] = 'User/canteen_daily_report';
$route['canteen_monthly_report'] = 'User/canteen_monthly_report';
$route['canteen-pass'] = 'User/canteenchangePass';
$route['access_plan'] = 'User/access_plan';
$route['device_access'] = 'User/device_access';
$route['canteen_summary'] = 'User/canteen_summary';
$route['student_access_report'] = 'User/student_access_report';
$route['visitor_log'] = 'User/visitor_log';
//live report

//$route['hostel_student_timing_report'] = 'User/hostel_student_timing_report';
$route['live_report'] = 'User/hostel_student_timing_report';
$route['hostel_student_timing_report/(:any)'] = 'User/hostel_student_timing_report/$1';
$route['hostel_student_timing_report_sm/(:any)'] = 'User/hostel_student_timing_report_sm/$1';
$route['hostel_student_timing_report/(:any)/(:any)'] = 'User/hostel_student_timing_report/$1/$2';
$route['hostel_student_timing_report_sm/(:any)/(:any)'] = 'User/hostel_student_timing_report_sm/$1/$2';
...
$route['add_s_holiday'] = 'User/School_holiday';
