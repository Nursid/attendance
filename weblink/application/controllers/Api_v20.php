...
use Google\Client;
class Api_v20 extends CI_Controller {
...
function addRfid(){
  ...
  function testNot(){
    ...
    $message = [
        'token' => "dLWVQMemQc2o1dscbQ_xl0:APA91bEbCLu7au7AbCsFwGBtY6OhtyYRFwrCUE-EYmSUHhVnuP5AdAdqNeJK7RM32r3ipEdSvHMUNxhOy4MXYPsCf_JVHq-1sUeDib6bpdsG3IGLtEuuOy7R_82_4bkmh5t6jaAgYdK_",
        'notification' => [
            'title' => $notificationTitle,
            'body' => $notificationMessage,
        ],
          ...
          if(!empty($usersData)){
            ...
            if(!empty($bus->firebassid)){
              $message = [
                ...
                'notification' => [
                    'title' => "Task Added",
                    'body' => "A new task has been added by ".$check['name'],
                ],
              ];
              $this->sendNotification($message);
            }
