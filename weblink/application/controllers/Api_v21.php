...
use Google\Client;
class Api_v21 extends CI_Controller {
...
///Appointment Booking History
 ...
 public function Appointhistorybussiness(){
   ...
   if(key($data)=="checkon"){
     ...
     $dep=$this->app->getAppointmentbussiness($dd,$start_time,$end_time);
 ...
 function addEmpLeave(){
  ...
  function addOfflineAttendance(){
    ...
    //   }
      ...
      $sendRes = array('msg'=>$msg,'status'=>$status,'offline'=>$newOffline,'company_data'=>$cmp_array,'holiday'=>$holidays,'group'=>$groups,'leaves'=>$leaves,'logout'=>'0','sections'=>$sections,'user_section'=>$check['section'],'options'=>$options,'user_images'=>$users_images,'task'=>$tasks,'rules'=>$rules,'notifications'=>$getNotifications);
