...
class Api_Model_v10 extends CI_Model
{
...
// 		$this->db->where('user_group','2');
	...
	public function updateDoj($id,$bid,$doj,$rule_id,$qr,$gps,$face,$colleague,$auto_gps,$gps_tracking,$field,$security,$gpsSelfie,$fieldSelfie,$qrMode){
		$sql = "UPDATE user_request SET doj='$doj',rule_id='$rule_id',qr='$qr',gps='$gps',face='$face',colleague='$colleague',auto_gps='$auto_gps',gps_tracking='$gps_tracking',field_duty='$field',four_layer_security='$security',selfie_with_gps='$gpsSelfie',selfie_with_field_duty='$fieldSelfie',qr_mode='$qrMode' WHERE user_id='$id' and business_id='$bid'";
		$res = $this->db->query($sql);
		return $res;
	}
