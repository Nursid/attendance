...
class Api_Model_v6 extends CI_Model
{
...
// 		$this->db->where('user_group','2');
	...
	public function getCompanyUsers($id){
		$sql = "SELECT user_request.user_id,user_request.doj,user_request.left_date,user_request.rule_id,(select name from login WHERE login.id = user_request.user_id) as name,(select image from login WHERE login.id = user_request.user_id) as image,(select business_group from login WHERE login.id = user_request.user_id) as business_group,user_request.user_status,(select login.designation from login WHERE login.id = user_request.user_id) as designation,(select login.m_id from login WHERE login.id = user_request.user_id) as mid,(select login.emp_code from login WHERE login.id = user_request.user_id) as emp_code,(select login.section from login WHERE login.id = user_request.user_id) as section,(select login.department from login WHERE login.id = user_request.user_id) as department FROM `user_request` WHERE user_request.business_id='$id'";
	...
	public function getEmpProfile($id,$bid){
		$sql = "SELECT *,(select business_groups.name FROM business_groups WHERE business_groups.id = login.business_group) as business_group_name,(SELECT user_request.doj FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as user_doj,(SELECT user_request.qr FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as qr,(SELECT user_request.gps FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as gps,(SELECT user_request.face FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as face,(SELECT user_request.colleague FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as colleague,(SELECT user_request.auto_gps FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as auto_gps,(SELECT user_request.gps_tracking FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as gps_tracking,(SELECT user_request.field_duty FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as field_duty,(SELECT user_request.four_layer_security FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as four_layer_security,(SELECT user_request.rule_id FROM user_request WHERE user_request.user_id='$id' and user_request.business_id='$bid') as rule_id FROM `login` where id ='$id' and user_group ='2'";
		$res = $this->db->query($sql);
		return $res->row();
	}
	...
	public function updateDoj($id,$bid,$doj,$rule_id,$qr,$gps,$face,$colleague,$auto_gps,$gps_tracking,$field,$security){
		$sql = "UPDATE user_request SET doj='$doj',rule_id='$rule_id',qr='$qr',gps='$gps',face='$face',colleague='$colleague',auto_gps='$auto_gps',gps_tracking='$gps_tracking',field_duty='$field',four_layer_security='$security' WHERE user_id='$id' and business_id='$bid'";
		$res = $this->db->query($sql);
		return $res;
	}
	...
	public function updateEmpOptions($bid,$auto_gps,$qr,$gps,$field,$security){
		$sql = "UPDATE user_request SET auto_gps='$auto_gps',qr='$qr',gps='$gps',field_duty='$field',four_layer_security='$security' WHERE business_id='$bid'";
		$res = $this->db->query($sql);
		return $res;
	}
	...
	public function updateCmpOptions($bid,$auto_gps,$qr,$gps,$field,$security){
		$sql = "UPDATE business_at_option SET auto_gps='$auto_gps',qr='$qr',gps='$gps',field_duty='$field',four_layer_security='$security' WHERE bid='$bid'";
		$res = $this->db->query($sql);
		return $res;
	}
