...
<!-- </select> -->
                              ...
                              <!-- </div> -->
                               ...
                               <div class="col-sm-3">
                                <input type="text" name="search" id="search" value="<?php echo isset($search) ? htmlspecialchars($search) : ''; ?>" class="form-control" placeholder="Search Name or Mobile...">
                              </div>
                              <div class="col-sm-2">
                      ...
                      if($load) {
                        ...
                        '&end_date='.$end_date.
                        '&bio='.$bio.
                        '&search='.(isset($search) ? urlencode($search) : '').
