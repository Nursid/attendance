                    ...
                    <div class="card">
                      <div class="card-body">
                       ...
                       <div class="row">
                            ...
                            <div class="col">
                              <p class="text-sm-left">Calculate Extra Days if present in Off days </p>
                            </div>
                            <div class="col-5"> 
                            </div>
                           <div class="col-1">
                              <div class="input-group">
                                <input id="edw_days<?php echo $rule->id;?>" type="number" placeholder="Days" name="edw_days" min="0" max="20" value="<?php echo ($rule->edw_days);?>"> 
                               
                                <script>
                                $(function() {
                                  $('#edw_days<?php echo $rule->id;?>').change(function() {
                                    $.ajax({
                                      url:'<?php echo base_url('User/update_attendance_rule_by_id')?>',
                                      data:{checked:$(this).val(),rule_id:<?php echo $rule->id;?>,type:'edw_days'},
                                      type:'post'
                                    });
                                  })
                                });
                            ...
                            <div class="col-2">
                              <input id="edw_on<?php echo $rule->id;?>" type="checkbox" data-toggle="toggle" data-onstyle="success" data-size="sm" <?php if($rule->edw_on>0){echo "checked";} ?>>
                              <script>
                              $(function() {
                                $('#edw_on<?php echo $rule->id;?>').change(function() {
                                  $.ajax({
                                    url:'<?php echo base_url('User/update_attendance_rule_by_id')?>',
                                    data:{checked:$(this).prop('checked'),rule_id:<?php echo $rule->id;?>,type:'edw_on'},
                                    type:'post'
                                  });
                                })
                              })
                          ...
                          <div class="row">
                            ...
                            <div class="col-4">
                              ...
                              <div class="input-group">
                                 ...
                                 <select name="ot_amount" id="ot_amount<?php echo $rule->id;?>"  class="bg-light"> 
                                <option value="<?php if($rule->ot_amount>0){?>"> Manual <?php } else { ?> Auto <?php } ?> </option>
                                                                <option value="0">Auto As Salary</option>
                                                                <option value="100">Manual</option>
                                                           </select>
                           &nbsp
                                                         
                                              <?php if($rule->ot_amount>0){?>
                                             <input id="ot_amount2<?php echo $rule->id;?>" type="number" placeholder="Amount" name="ot_amount2" min="1"  value="<?php echo ($rule->ot_amount);?>"> 
                                         <?php }?>    
                              ...
                              <script>
                                $(function() {
                                  $('#ot_amount2<?php echo $rule->id;?>').change(function() {
                                    $.ajax({
                                      url:'<?php echo base_url('User/update_attendance_rule_by_id')?>',
                                      data:{checked:$(this).val(),rule_id:<?php echo $rule->id;?>,type:'ot_amount'},
                                      type:'post'
                           ...
                           <div class="col-2">
                              <div class="input-group">
                                <input id="ot_time_hr<?php echo $rule->id;?>" type="number" placeholder="Hr" name="ot_time_hr" min="0" max="23" value="<?php echo getHrs($rule->ot_time);?>">
                                <input id="ot_time_mn<?php echo $rule->id;?>" type="number" placeholder="Min" name="ot_time_mn" min="0" max="59" value="<?php echo getMin($rule->ot_time);?>">Hr
                                <script>
                                $(function() {
                                  $('#ot_time_hr<?php echo $rule->id;?>').change(function() {
                                    $.ajax({
                                      url:'<?php echo base_url('User/update_attendance_rule_by_id')?>',
                                      data:{checked:$(this).val(),rule_id:<?php echo $rule->id;?>,type:'ot_time',checkedMin:$("#ot_time_mn<?php echo $rule->id;?>").val()},
                                      type:'post'
                                    });
                                  })
                                });
                                $(function() {
                                  $('#ot_time_mn<?php echo $rule->id;?>').change(function() {
                                    $.ajax({
                                      url:'<?php echo base_url('User/update_attendance_rule_by_id')?>',
                                      data:{checked:$("#ot_time_hr<?php echo $rule->id;?>").val(),rule_id:<?php echo $rule->id;?>,type:'ot_time',checkedMin:$(this).val()},
                                      type:'post'
                                    });
                                  })
                                });
