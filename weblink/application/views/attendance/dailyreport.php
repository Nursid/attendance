...
<body class="hold-transition sidebar-mini">
  ...
  function exportExcel(){
    var wb = new ExcelJS.Workbook();
      ...
      sh.columns = [
        ...
        {header: 'LateIn', key: 'LateIn', width: 15},
        {header: 'EarlyOut', key: 'EarlyOut', width: 15}
      ];
      <?php
        $count=1;
        foreach($report as $user){
        ...
        ?>
        sh.addRow({SNo:'<?php echo $count++;?>',Empcode:'<?php echo $user['emp_code'];?>',Name:'<?php echo $user['name'];?>',Designation:'<?php echo $user['designation'];?>',Shift:'<?= $shift;?>',IN:'<?= $allIns;?>',Out:'<?= $allOuts;?>',Status:'<?= $st;?>',WH:'<?= $user['workingHrs'];?>',LateIn:'<?= $user['late_hrs'];?>',EarlyOut:'<?= $user['early_hrs'];?>'});
      ...
      <?php 
         ...
         <?php 
          ...
          echo "sh.insertRow(2, ['Daily Attendance Report for date of $new_start_date ']);";
        
        echo "sh.mergeCells('A1:K1');";
          echo "sh.mergeCells('A2:K2');";
  ...
  function createHeaders(keys) {
    ...
    result.push({id: 'Empcode',name: 'Empcode',prompt: 'Empcode',width: 40,align: 'center',padding: 0});
    ...
    result.push({id: 'IN',name: 'IN',prompt: 'IN',width:30,align: 'center',padding: 0});
    result.push({id: 'Out',name: 'Out',prompt: 'Out',width: 30,align: 'center',padding: 0});
    ...
    result.push({id: 'LateIn',name: 'LateIn',prompt: 'LateIn',width: 30,align: 'center',padding: 0});
    result.push({id: 'EarlyOut',name: 'EarlyOut',prompt: 'EarlyOut',width: 30,align: 'center',padding: 0});
    return result;
  }
  function exportPDF(){
    var result = [];
    <?php
        ...
        foreach($report as $user){
          ...
          ?>
        var data = {id:"<?php echo $count;?>",SNo:"<?php echo $count++;?>",Empcode:"<?php echo $user["Emp_code"];?>",Name:"<?php echo $user["name"];?>",Designation:"<?php echo $user["designation"];?> ",Shift:"<?= $shift;?>",IN:"<?= $allIns;?>",Out:"<?= $allOuts;?>",Status:"<?= $st;?>",WH:"<?= $user["workingHrs"];?>",LateIn:"<?= $user["late_hrs"];?>",EarlyOut:"<?= $user["early_hrs"];?>"};
    ...
    doc.text("Daily Attendance Report of <?php echo $new_start_date; ?> ",145,15,null,null,"center");
    doc.table(3, 25, result, headers, { autoSize: false,fontSize:10,padding:1,margins:{left:0,top:3,bottom:3, right:0} });
