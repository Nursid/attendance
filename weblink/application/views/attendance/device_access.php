      ...
      <div class="container-fluid">
           ...
           <button type="button" class="btn btn-primary btn-sm mt-4 mx-auto" data-toggle="modal" data-target="#Modal-12">Enable User </button>
            ...
            <button type="button" class="btn btn-primary btn-sm mt-4 mx-auto" data-toggle="modal" data-target="#Modal-13">Disable User </button>
                 ...
                 <div class="card-body">
                  ...
                  <form action="<?php echo base_url('User/import_txtlog')?>" method="post" enctype="multipart/form-data">
       <!--  <label for="file">Choose text file:</label>
        ...
        <div class="row">
         ...
         <div class="from-group col-md-2"> <br>
           <button type="submit" name="submit">Import Log</button>
          </div>
          </div>
               ...
               <div class="card-body">
                  ...
                  <form action="<?php echo base_url('User/import_excellog')?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
         ...
         <input type="submit" value="Import Log">
          </div>
          </div>
         ...
         <div class="from-group col-md-2">
          <button class=" btn btn-info mt-4 mx-auto">Check</button> 
                          ...
                          <div class="modal fade" id="Modal-5" tabindex="-1" role="dialog" aria-labelledby="historyModal" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content"> 
                                ...
                                <div class="modal-body">
                                <span style="color: red"><?php echo $this->session->flashdata('msg');?></span>
                                <form action="<?php echo base_url('Api_v17/transferBioAttendance')?>" method="post">
            ...
            ?></select>
             <input type="hidden" id="action" name="model" value="<?php echo $model ;?>"/>
            <input type="hidden" id="action" name="buid" value="<?php echo $buid ;?>"/>
            </div>
