...
<?php
   if($this->session->userdata()['type']=='B' || $this->session->userdata()['type']=='A' ){ 
          ...
          <div class="col-md-12">
           ...
           <button type="button" class="btn btn-primary btn-sm mt-4 mx-auto" data-toggle="modal" data-target="#Modal-12">Enable User </button>
            ...
            <button type="button" class="btn btn-primary btn-sm mt-4 mx-auto" data-toggle="modal" data-target="#Modal-13">Disable User </button>
                 ...
                 <div class="card-body">
                    <!-- /.Form starts -->
                    <h5>Import from Text File </h5>
                    <div class="row">
                      <div class="col-lg-12 float-left">         
                      
                  <form action="<?php echo base_url('User/access_report2')?>" method="post" enctype="multipart/form-data">
       <!--  <label for="file">Choose text file:</label>
        <input type="file" name="file" id="file" required><br><br>

        <label for="from_date">From Date (YYYY-MM-DD):</label>
        <input type="date" name="from_date" id="from_date" required><br><br>
        ...
        <div class="row">
           ...
           <?php
             $res=$this->web->getalldevice();
            
              if(!empty($res)){
                            foreach($res as $res):
                                $uname = $this->web->getNameByUserId($res->bid);
                               // echo $uname[0]->name;
                              // $model=$res->model;
                              echo "<option value=".$res->id .">".$uname[0]->name."(".$res->deviceid .")</option>";
                            endforeach;
                          }
         ...
         <div class="from-group col-md-2">
           ...
           <div class="card-body">
                    ...
                    <h5>Import from Excel File </h5>
                    <div class="row">
                      <div class="col-lg-12 float-left">         
                      
                  <form action="<?php echo base_url('User/access_report3')?>" method="post" enctype="multipart/form-data">
      
        
        <div class="row">
                                          <div class="col-sm-2">
                                              <br>
                              <input type="date" name="from_date" id="from_date"  value="<?php echo date("Y-m-d"); ?>" class="form-control" max="<?php echo $end_date; ?>" onchange="startChange(event);">
                            </div>
                            <div class="col-sm-2">
                                <br>
                              <input type="date" name="to_date" id="to_date" value="<?php echo date("Y-m-d"); ?>"class="form-control" max="<?php echo date('Y-m-d'); ?>" min="<?php echo $start_date;?>" onchange="endChange(event);">
                            </div>
         ...
         <div class="from-group col-md-2">
          <button class=" btn btn-info mt-4 mx-auto">Import Log</button> 
          </div>
          </div>
                          ...
                          <div class="modal fade" id="Modal-5" tabindex="-1" role="dialog" aria-labelledby="historyModal" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                <span style="color: red"><?php echo $this->session->flashdata('msg');?></span>
                                <form action="<?php echo base_url('Api_v18/transferBioAttendanceadmin')?>" method="post">
                          ...
                          <div class="modal fade" id="Modal-12" tabindex="-1" role="dialog" aria-labelledby="historyModal" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                <span style="color: red"><?php echo $this->session->flashdata('msg');?></span>
                                <form action="<?php echo base_url('Api_v18/enablebiometricalluser')?>" method="post">
                                 <table id="example2" class="table table-bordered table-responsive">
                                    <thead>
                                     <tr>
                                     <th colspan="5"> 
         ...
         <div class="from-group col-md-3">
          <button class=" btn btn-info mt-4 mx-auto">Disable Now</button> 
                                    ...
                                    <tbody>
                                      ...
                                      $count=1;
                                     // $stu=$this->web->getHostelStudentList($buid);
                                       $stu=$this->web->getWorkingEmployeesList($buid);
                                      foreach($stu as $value){
