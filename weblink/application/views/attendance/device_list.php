                                    ...
                                    <option value="1">In</option>
                                      <option value="2">Out</option>
                                        <option value="3">Access</option>
                                          <option value="11">Visitor mgt</option>
                                </select>
                  </div>
                <div class="from-group col-md-3">
        ...
        <div class="row">
                  ...
                  <tbody>
                    ...
                    <!--   <td>
                       ...
                       <?php echo date('h:i',$res->update_date); ?>
                        ...
                        <?php 
                       // echo $res->id;
                        $sections = $this->web->getsectionbydeviceid($res->id);
                        
                             if(!empty($sections)){
                           $sectionsname = $this->web->getBusinessSectionById($sections[0]->section_id);
                          echo $sectionsname[0]->name;
                         } else{ 
                         echo "No Section";
                           ...
                           ?>
                            <br>
                        <button type="button" class="btn btn-danger btn-sm mt-4 mx-auto" data-toggle="modal" data-target="#addModal<?php echo $res->id;?>">Add </button>
                        
                        <button type="button" class="btn btn-info btn-sm mt-4 mx-auto" data-toggle="modal" data-target="#historyModal<?php echo $res->id;?>">History</button>
                            ...
                            <div class="modal-dialog modal-md" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="historyModalLabel<?php echo $res->id;?>">Assign Section</h5>
                                ...
                                <div class="modal-body">
                                  ...
                                  <form action="<?php echo base_url('User/Assign_secttion_device')?>" method="post">
              <div class="card-body">
                <div class="row">
                  ...
                  <!--  <input type="date" class="form-control" name="from_date" placeholder="Select Date" id="from_date" required>-->
                     <input type="datetime-local"  name="from_date" placeholder="Select Date" id="start_date" value="<?php echo $start_date; ?>" class="form-control" max="<?php echo $end_date; ?>" onchange="startChange(event);" required>
                  </div>

                  
                <div class="col-md-5 form-group">
            <label for="department">Section</label>
           <select name="section_id" class="form-control"   style="width: 100%;" required>
         <!-- <select name="department" class="form-control">-->
            ...
            ?></select>
                    ...
                    <input type="hidden" name="device_id" value="<?php echo $res->id;?>">
                     <input type="hidden" name="bid" value="<?php echo $bid; ?>">
