                      ...
                      <br>
                       ...
                       <?php } ?>
                        ...
                        <br>
                           <?php
      if($this->session->userdata()['type']=='B' || $role[0]->add_emp=="1" || $role[0]->type=="1"){?>  
                        <!--  <button type="button" class="btn btn-info btn-circle btn-x" data-toggle="modal" data-target="#editShiftModal<?= $res->id;?>">Weeklyoff</button>-->
                      <?php }?>
           ...
           <!--<div class="modal fade" id="editShiftModal<?= $res->id;?>" tabindex="-1" role="dialog" aria-labelledby="editShiftModalLabel<?= $val->user_id;?>" aria-hidden="true">
