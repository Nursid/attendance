                        ...
                        <table id="example1" class="table table-bordered table-responsive">
                          ...
                          <tbody>
                            ...
                            foreach($report as $user){
                                $dp=$this->web->getBusinessDepByUserId($user['dep']);
                                 $section = $this->web->getBusinessSecByUserId($bid,$user['section']);
                              ?>
                              <tr>
 ...
 <script>
    ...
    function export_datas(){
      ...
      sh.columns = [
        ...
        {header: 'Department', key: 'Dep', width: 15},
  ...
  $section = $this->web->getBusinessSecByUserId($bid, $user['section']);
          ?>
          sh.addRow({SNo:'<?php echo $count;?>',Empcode:'<?php echo $user['emp_code'];?>',Name:'<?php echo $user['name'];?>',Dep:'<?php echo $dp[0]->name;?>',Section:'<?php echo $section[0]->name;?>',
          <?php
           if($status_check=="1" || $working_check=="1" || $all_check=="1" || $two_check=="1" || $late_check=="1" || $early_check=="1"){
               $dayCount = 0;
          foreach($user['data'] as $day){
