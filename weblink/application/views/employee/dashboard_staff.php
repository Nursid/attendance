...
$inact="SELECT count(id) as inactemp FROM user_request WHERE business_id='$id'and user_status=0 and left_date ='' ";
 ...
 <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url('employees')?>" class="small-box-footer">Attendance Report <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
...
<div class="col-lg-3 col-xs-6">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-lime">
                ...
                <a href="<?php echo base_url('leave')?>" class="small-box-footer"> Leave Mgt <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
