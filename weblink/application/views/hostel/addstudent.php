        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
             ...
             <form method="post" enctype="multipart/form-data" action="<?php echo base_url('User/import_student')?>">
<input type="file" id="excel_file" name="excel_file">
<input type="hidden" id="business_id" name="business_id">
  <input type="submit" value="Upload">
</form>
<a download href="<?php echo base_url() ?>/upload/template/student.xlsx">Download Student Sample file</a>
</div>
...
<a download href="<?php echo base_url() ?>/upload/template/staff_bank_detail.xlsx"> Download bank detail Sample file</a>                
                  ...
                  if (!empty($umobile)){
                    ...
                    <form action="<?php echo base_url('User/addstaff')?>" method="post">
                      <div class="card-body">
                        ...
                        <form action="<?php echo base_url('User/addnewstudent')?>" method="post">
                          <div class="card-body">
                            <div class="row">
                              <div class="from-group col-md-5">
                                <label for="mobile">Enroll ID/Mobile No</label>
                              ...
                              <div class="from-group col-md-5">
                                <label for="desig">Class/ Qualification</label>
                                <input type="text" class="form-control" name="edu" id="desig" placeholder=""  >
                              </div>
                              <div class="from-group col-md-5">
                 <label for="block">Block/Section</label>
				   ...
				   $blocks = $this->web->getallBlock($buid);
                    if(!empty($blocks)){
                  ...
                  <div class="from-group col-md-5">
                    ...
                    <input type="text" class="form-control" name="floor" placeholder="Enter Floor" id="floor">  
                  ...
                  <div class="from-group col-md-5">
                    ...
                    <input type="text" class="form-control" name="room" placeholder="Enter Room No" id="room">
                  </div>
                 ...
                 <label for="Roomtype">Room Type</label>
				   ...
				   $roomstype = $this->web->getallrooms($buid);
                    if(!empty($roomstype)){
                   ...
                   ?></select>
                                  ...
                                  <div class="from-group col-md-5">
                                    <br>
                                    <button  class=" btn btn-success mt-4 mx-auto" >Add to Hostel</button>
                                    <a href="<?php echo base_url('student_list')?>"<button class=" btn btn-success mt-4 mx-auto" >Cancel</button> </a>
                                  </div>
                                </div>
                              </div>
