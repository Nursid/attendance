            ...
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-lg-12 float-left">
                        <form action="<?php echo base_url('User/canteen_daily_report')?>" method="POST">
                          <div class="row">
                            <div class="col-sm-2">
                    ...
                    if($load) {
                      ...
                      ?>
                    <!-- <h5>Punch Detail for Date of :-<?php echo date("d-M-Y ",$stdate)?> </h5> -->
                     
                      <div align="right"  >
                        <input type="button" onClick="exportExcel22()" value="Export To Excel" />
                        <input type="button"  id="btnExport22" value="Export To Pdf" onclick="exportPDF22()" />
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        <thead>
                          <?php
                          echo "<tr> <td colspan='12'> <h5>Punch Detail of:-".date("d-M-Y ",$stdate)." </h5></td></tr>";
                          
                          ?>
                         <tr> <td colspan="12">
                         <?php foreach($res as $rest){
                           echo $rest->name ." : ". $punchtime ." ,  "; 
                           } ?>
                         </td>
                        </tr>
                          ...
                          <?php
                          echo " <tr> <td colspan='12'> <h6> Total Punch: ".$totallog." , ";
                         echo "Active User : ".$totalActive ."</h6></td></tr>" ;?>
                          <tr>
                            <th>S.No</th>
                            <th>Name</th>
                            <th>Block</th>
				...
				//	$new_end_time = strtotime(date("d-m-Y 23:59:59",strtotime($start_date))); 
					...
					$res2=$this->web->getTimingByBusinessId($bid);
