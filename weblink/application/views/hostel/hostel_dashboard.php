    ...
    <!-- /.content -->
     ...
     <!-- Main content -->
       	   ...
       	   // $cudate= '2022-07-20';
				...
				$start_time= strtotime(date("Y-m-d 00:00:00",$cdate));
                $end_time= strtotime(date("Y-m-d 23:59:59",$cdate));
                $start_time2= strtotime(date("Y-m-01 00:00:00",$cdate));     
				$act="SELECT count(id) as actemp FROM user_request WHERE business_id='$id'and user_status=1 and hostel=1 and  left_date ='' ";
               ...
               $present_daily= $pnt_daily[0]->present;
                ...
                $time_daily="SELECT count(id) as present FROM attendance WHERE  io_time BETWEEN $start_time and $end_time and bussiness_id='$id'";
               $times_daily= $this->db->query($time_daily)->result();
			 
               $timin_daily= $times_daily[0]->present;
				
				
				$pren_mont="SELECT count(id) as mont FROM attendance WHERE io_time BETWEEN $start_time2 and $end_time and bussiness_id='$id'";
               $pnt_mont= $this->db->query($pren_mont)->result();
			 
               $present_mont= $pnt_mont[0]->mont;
...
// box calculation
 ...
 <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url('student_list')?>" class="small-box-footer">Student Detail <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
...
<div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                 <h4><?php echo  $present_daily ;?></h4>
                  <p>Today Hostel Log</p>
                </div>
                <div class="icon">
                 <i class="fa fa-users"></i>

                </div>
                <a href="<?php echo base_url('hostel_daily_report')?>" class="small-box-footer">Hostel Daily Report <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-lime">
                <div class="inner">
                 <h4><?php echo $timin_daily ;?></h4>
                  <p>Today Canteen Access</p>
                </div>
                <div class="icon">
                 <i class="fa fa-users"></i>

                </div>
                <a href="<?php echo base_url('canteen_daily_report')?>" class="small-box-footer">Report Detail <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <h4><?php echo   $present_mont;?></h4>
                  <p>Monthly Canteen Access</p>
                </div>
                <div class="icon">
                 <i class="fa fa-users"></i>

                </div>
                <a href="<?php echo base_url('canteen_monthly_report')?>" class="small-box-footer">Report Detail<i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
...
<section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
<?php
$res2=$this->web->getTimingByBusinessId($id);
					foreach($res2 as $res2){ 
	$start_times=strtotime (date("h:i A" ,$res2->start_time));
   $end_times=strtotime (date("h:i A" ,$res2->end_time));				    
					    
 $pren_daily="SELECT count(id) as present FROM attendance WHERE io_time BETWEEN $start_times and $end_times and bussiness_id='$id'";
               $pnt_daily= $this->db->query($pren_daily)->result();
			 
               $punch_daily= $pnt_daily[0]->present;
...
?>
 ...
 <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-blue">
                <div class="inner">
                 <h4> 
                     <?php echo  $punch_daily ; ?>
                     </h4>
                   <h4><?php  echo $res2->name ; ?> </h4>
                </div>
                <div class="icon">
                 <i class="fa fa-users"></i>
...
$start_times=strtotime (date("h:i A" ,$res2->start_time));
 ...
 $start_time= strtotime(date("Y-m-01 00:00:00",$cdate));
 $end_time= strtotime(date("Y-m-d 23:59:59",$cdate));
   $mont_detail=$this->web->getcanteenattByBusinessId($start_time,$end_time,$id);
   $time=0;
 	foreach($mont_detail as $detail){
 	    if((strtotime(date("h:i A" ,$detail->io_time))>=$start_times) && (strtotime (date("h:i A" ,$detail->io_time))<=$end_times) ){
 	        $time++;
 	    }
}
?>
