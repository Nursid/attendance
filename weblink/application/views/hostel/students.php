               ...
               //  echo   $str1 = $str1 + 1;
				...
				$start_time=time();
                      ...
                      <tr>
                       <td><?php echo $count++; ?></td>
                        ...
                        <td><?php $uname = $this->web->getNameByUserId($val->user_id);
                                ...
                                <td>
                               <img src="<?php echo base_url($uname[0]->image);?>" height="50"  width="70"/>
                              <?php
                             // echo $uname[0]->image;
                              ?>
                     ...
                     <!--   <td>  
                        ...
                        <td> 
                        <a href="<?php echo base_url('User/editstudent?id=') . $val->user_id ?>"
                       
                 
                  
               
                          <button type="button"  class="btn btn-primary btn-lg"  value="('<?php echo $val->user_id; ?>')">
                            <i class="fas fa-edit"></i>
                          </button>  </a>
                          </td>
                          <td>
                          <form action="<?php echo base_url('User/upload_image')?>" method="post" enctype="multipart/form-data">
                       <!-- <label>Select JPEG image to upload:</label>-->
                      <input type="file" name="image" accept="image/jpeg">
                      <input type="hidden" name="id" id="id" value="<?php echo $val->user_id; ?>">
