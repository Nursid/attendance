...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  $image="";
  $name="";
  if($this->web->getBusinessById($this->session->userdata()['login_id'])!=null){
      $this->web->getBusinessById($this->session->userdata()['login_id'])['image'];
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          foreach ($page as $key => $page) {
            ...
            if($data!=null && $data['assign_menu_id']==$page->page_id && $data['status']==0){
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
             <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('device_access_att')?>" class="nav-link">
                  <i class="far fa-user nav-icon"></i>
                  <p>Device Access  </p>
                </a>
              </li> 
            ...
            if($this->session->userdata()['type']=='A'){
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                <a href="<?php echo base_url('bio_detail')?>" class="nav-link">
                  <i class="far fa-user nav-icon"></i>
                  <p>Device Detail  </p>
                </a>
              </li> 
                   ...
                   <li class="nav-item">
                <a href="<?php echo base_url('device_access_admin')?>" class="nav-link">
                  <i class="far fa-user nav-icon"></i>
                  <p>Device Access  </p>
                </a>
              </li> 
