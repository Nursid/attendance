        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-info">
			  ...
			  ?>
              <form action="<?php echo base_url('User/add_salary_head')?>" method="post">
              <div class="card-body">
                <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                 <?php
					  $dp = $this->web->getHeadByBusinessId($bid);
					  ?>
                  <td>1</td>
                        <td> TA</td>
                        <td>Allowance</td>
                   
                  <td> <!--<input class="form-control-mini" type="checkbox" value=""  name="TA" <?php if($dp['0']->name==TA){ echo "checked";}?>-->
                 <input id="TA" type="checkbox"  name="TA" data-toggle="toggle" data-onstyle="success" data-size="sm" <?php if($dp['0']->name=="TA"){echo "checked";} ?>>
                              <script>
                            $(function() {
                            $('#TA').change(function() {
                                $.ajax({
                                url:'<?php echo base_url('User/update_salary_head')?>',
                                data:{checked:$(this).prop('checked'),type:'TA'},
                                type:'post'
                                });
                            });
                            });
