      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Subject</h3><br>
                <span style="color: red"><?php echo $this->session->flashdata('msg');?></span>
              </div>
              <form action="<?php echo base_url('User/add_newsubject')?>" method="post">
              <div class="card-body">
                <div class="row">
                     <div class="from-group col-md-3">
                          <label for="depart">Branch</label>
                    <?php
                  ...
                  <div class="from-group col-md-3">
                    <label for="depart">Subject Code</label>
                    <input type="text" class="form-control" name="subcode" placeholder="Enter code" id="depart" required>
                  </div>
         ...
         <div class="row">
             ...
             <form method="post" enctype="multipart/form-data" action="<?php echo base_url('User/import_subject')?>">
<input type="file" id="excel_file" name="excel_file">
<input type="hidden" id="business_id" name="business_id">
  <input type="submit" value="Upload">
</form>
<a download href="<?php echo base_url() ?>/upload/template/import_subject.xlsx">Download Subject Sample file</a>
</div>  
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                      $res = $this->web->getallsubjectbyid($buid);
                      $count=1;
                      foreach($res as $res){
                      ?>
                      <tr>
