          ...
          <div class="col-md-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add holidays</h3><br>
                <span style="color: red"><?php echo $this->session->flashdata('msg');?></span>
              </div>
              <?php 
			  // $bid=$this->web->session->userdata('login_id');
			   ?>
             <form action="<?php echo base_url('User/add_holiday_new')?>" method="post">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="from-group col-md-3">
                        ...
                        <input type="text" class="form-control" name="h_dates" id="datepicker" placeholder="Select multiple dates" required>
                        <!-- Note: Changed name to h_dates (plural) since multiple dates will be stored -->
                      </div>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td id="delete<?php echo $res->id; ?>">
                          ...
                          <button class="btn btn-danger" onclick="delete_holiday('<?php echo $res->id; ?>')" >
