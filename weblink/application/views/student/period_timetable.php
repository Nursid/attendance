                                  ...
                                  echo '<tr>
                                      ...
                                      <select class="form-control select-subject" data-entry-id="'.$entry->id.'">
                                        ...
                                        if(!empty($subjects)) {
                                          foreach($subjects as $subject) {
                                            ...
                                            echo '<option value="'.$subject->id.'" '.$selected.'>'.$subject->name."(Code:- ".$subject->Subject_code.") ".'</option>';
                                          }
                                        }
                                      echo '</select>
                                    </td>
                                    <td>
                                      <select class="form-control select-teacher" data-entry-id="'.$entry->id.'">
                                        ...
                                        $teachers=$this->web->getSchoolTeachersList($bid);
                                        if(!empty($teachers)) {
                                          foreach($teachers as $teacher) {
                                              $uname = $this->web->getNameByUserId($teacher->uid);
                                              
                                            $selected = ($entry->teacher == $teacher->uid) ? 'selected' : '';
                                            echo '<option value="'.$teacher->uid.'" '.$selected.'>'.$uname[0]->name.'</option>';
                                          }
                                        }
                                      echo '</select>
                                    </td>
                                    <td>
                                      <select class="form-control select-classroom" data-entry-id="'.$entry->id.'">
                                        ...
                                        $classrooms = $this->web->getallclassbyid($bid); 
          ...
          <form id="periodForm">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="subject" name="subject" required>
                ...
                if(!empty($subjects)) {
                  foreach($subjects as $subject) {
                    echo '<option value="'.$subject->id.'">'.$subject->name."(Code:- ".$subject->Subject_code.") ".'</option>';
                  }
                }
                ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="teacher" name="teacher" required>
                ...
                if(!empty($teachers)) {
                  foreach($teachers as $teacher) {
                      $uname = $this->web->getNameByUserId($teacher->uid);
                    echo '<option value="'.$teacher->uid.'">'.$uname[0]->name.'</option>';
                  }
                }
                ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="class_room" name="class_room" required>
                ...
                <?php
                // Get classrooms or create sample ones if method doesn't exist
                $classrooms = $classrooms = $this->web->getallclassbyid($bid);  
