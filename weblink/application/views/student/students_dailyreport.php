  ...
  <table id="example1" class="table table-bordered table-striped">
    <thead>
      <?php
       ...
       $semesterName2 = $this->web->getSemesterById($semester);
      
      echo "<tr> <td colspan='12'> Attendance For Date:-".$start_date." And  Department:- ".$department. "  And Semester:- ".$semesterName2[0]->semestar_name. "  And Section:- ". $sect." </td></tr>";
      ?>
      <tr>
        <th>S.No</th>
        <th>Roll No</th>
    ...
    <tbody>
      ...
      foreach($report as $user){
        ...
        $semesterName = $this->web->getSemesterById($val[0]->semester);
        ?>
        <tr>
          <td><?php echo $count++;?></td>
        <!--  <td><?php echo $classn;?></td>
          <td><?php echo $semesterName[0]->semestar_name; ?></td>-->
          <td><?php echo $sid;?></td>
...
function exportTableToExcel(tableID, filename = 'student_daily_report.xlsx') {
  ...
  var sect = "<?php echo $sect; ?>";
    var semesterId = "<?php echo $semester ?>";
  var semester = <?php echo json_encode($this->web->getSemesterById($semester)); ?>;
  ...
  headerCell.value = "Attendance For Date: " + start_date + " And Department: " + department + " And Semester: " + semester[0].semestar_name + " And Section: " + sect;
