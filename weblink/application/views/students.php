                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <select name="subject" class="form-control">
                          ...
                          <option value=''>Sankrit</option>
                          <option value=''>Economics</option>
                          <option value=''>Psychology</option>
                          <option value=''>Business Computing </option>
                          <option value=''>Quntitative Methods</option>
                          <option value=''>Corporate Communication</option>
                          <option value=''>Advanced option Research</option>
