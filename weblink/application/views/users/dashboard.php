...
<div class="col-lg-3 col-xs-6">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-lime">
                ...
                <a href="<?php echo base_url('leave')?>" class="small-box-footer">Approve Leave <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="" class="small-box-footer">Approve Attendance<i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
