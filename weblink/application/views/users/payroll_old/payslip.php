        ...
        <div class="">
            <table class="" border="2">
                <thead>
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-20">
                                            ...
                                            <?=$val['header_type'] == "Manual" ? $val['amount'] : round((((($ctc_salary->basic_value)/$number_of_days)*$working_days)*$val['header_value']))/100;?>
                                            <?php }else {
                                                echo $val['amount'];
                                            } ?>
                                        </td>
                    ...
                    <tr>
                        <td>Total : <?=$EARNINGS+$salary['basic_value']; ?></td>  
                        <td>Total : <?=$DEDUCTION; ?></td>      
                    </tr>
                    <tr>
                        <td></td>
                        <td>NetPayable : <?= isset($_GET['netPayable']) ? $_GET['netPayable'] : 0; ?></td>
                    </tr>
                </thead>
            </table>
            <br>
