        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">ExStudent List
                </h3>
              </div>
              <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				...
				$start_time=time();
                      $res=$this->web->getexHostelStudentList($id);
					  $count=1;
                      ...
                      <tr>
                       <td><?php echo $count++; ?></td>
                        ...
                        <td id="activate<?php echo $val->user_id; ?>">
                          ...
                          ?>    
                            <button class="btn btn-danger" onclick="active2('<?php echo $val->user_id; ?>')" >Inactive</button>
                          <?php
                              }elseif($val->user_status == "1"){
                          ?>
                            <button class="btn btn-success" onclick="inactive2('<?php echo $val->user_id; ?>')" >Active</button>
